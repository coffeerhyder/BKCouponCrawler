...
from Helper import *
from Helper import getPathImagesOffers, getPathImagesProducts, INFO_DB, couponTitleContainsFriesOrCoke, isCouponShortPLU, isValidImageFile
...
class BKCrawler:
    ...
    def crawlAndProcessData(self):
        ...
        self.updateIsNewFlags(lastValidCoupons)
